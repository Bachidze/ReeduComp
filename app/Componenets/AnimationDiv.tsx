...
export default function AnimationDiv() {
  ...
  return (
    <main
      className={`relative overflow-hidden border-2 pt-6 pl-[60px] pb-[65px]  bg-black transition-colors duration-300 ${
    ...
    >
      <section className="flex justify-between relative z-20">
        <div>
          <h1 className="text-[36px] font-medium leading-normal uppercase duration-500">
            ვებ პროგრამირება
          </h1>
          <p className="py-5 w-[768px] text-[20px] leading-normal font-normal duration-500">
            ვებ პროგრამირების 10 თვიანი კურსი მსმენელს საფუძვლიანად შეასწავლის
            Javasctipt, React JS და Node Js ტექნოლოგიას, რაც აუცილებელია
            ...
            ფარგლებში მსმენელი დაეუფლება ისეთ მიმართულებებს, როგორებიცაა:
          </p>
          <nav>
      ...
      <section className="flex justify-between pt-[72px] relative z-20">
        ...
        >
          ...
          >
            ...
            <h2 className="pt-[10px] text-[16px] leading-normal font-medium">
              შეხვედრების რაოდენობა
            </h2>
            <h3 className="text-[12px] leading-normal font-medium">
              100 შეხვედრა
            </h3>
          </motion.div>
          <motion.div
        ...
        <div className={`pr-[82px] gap-5 flex flex-col`}>
          <h2 className="bg-[#91C6EA] cursor-pointer py-2 px-4 rounded-[10px] w-[195px] text-[24px] leading-normal duration-300 font-medium hover:bg-transparent border-2 border-[#91C6EA] box-border">
            დეტალურად
          </h2>
